...
class PersonPage extends Component {
  ...
  getDetail = index => {
    ...
    this.selectedPerson.email = displayedPersons[index].email[0].value
    this.selectedPerson.org =
      displayedPersons[index]['ca3be488eca6a56b4f8de5ff7fa241260fed6a85']
    this.selectedPerson.assistant =
      displayedPersons[index]['e94d294620a4326580775c98cd25df13a0d0633b']
    this.selectedPerson.group =
      displayedPersons[index]['d40004cf0ff966b68553a55bfa6a56db33f8ed78']
    this.selectedPerson.location =
      displayedPersons[index]['6a63d45d54afca4389fc067a099016966ac36cca']
      ...
      <div className="page">
        ...
        <div className="row">
          ...
          >
            ...
            <PersonForm onAddPerson={values => this.props.addPerson(values)} />
